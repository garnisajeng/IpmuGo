...
const CrudDataReader = () => {
	...
	{/* <!-- My CSS --> */}
	<link rel='stylesheet' type="text/css" href={CrudDataReadercss}></link>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">List Readers</a>
						</li>
					</ul>
				</div>
                <a href="#" class="btn-download">
                <span class="material-symbols-outlined">add</span>
					<span class="text">Add New Readers</span>
				</a>
			</div>
