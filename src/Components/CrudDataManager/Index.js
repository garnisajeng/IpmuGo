...
const CrudDataManager = () => {
	...
	{/* <!-- My CSS --> */}
	<link rel='stylesheet' type="text/css" href={CrudDataManagercss}></link>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">List Managers</a>
						</li>
					</ul>
				</div>
                <a href="#" class="btn-download">
                <span class="material-symbols-outlined">add</span>
					<span class="text">Add New Manager</span>
				</a>
			</div>
...
export default CrudDataManager;