...
const CrudDataArticle = () => {
	...
	{/* <!-- My CSS --> */}
	<link rel='stylesheet' type="text/css" href={CrudDataArticlecss}></link>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">List Articles</a>
						</li>
					</ul>
				</div>
                <a href="#" class="btn-download">
                <span class="material-symbols-outlined">add</span>
					<span class="text">Add New Articles</span>
				</a>
			</div>
...
export default CrudDataArticle;