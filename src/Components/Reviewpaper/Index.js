...
import Reviewpapercss from '../../Assets/CSS/Reviewpaper.css';
import Profile from '../../Assets/images/people.png';

const Reviewpaper = () => {
    return(
        <>
           <section className="reviewpaper">
	<meta charset="UTF-8" />
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="#">Review Paper</a>
						</li>
					</ul>
				</div>
